...
import static me.elrhezzalimanal.mylibrary.BookActivity.BOOK_ID_KEY;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(BOOK_ID_KEY, books.get(position).getId());//the Id for each book is unique
                ...
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                //by leaving this method's body blank the Dialog gets dismissed if the user click the No btn
                            }
                        });
                        builder.create().show();
//
